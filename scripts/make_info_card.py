...
# ===========================================================================
HOST = "7H-ANKUR"   # shown as  7H-ANKUR@github  in the header

ROWS = [
    ("host",),
    ("kv", "Role",    "ML Engineer · Data Science Student"),
    ("kv", "Edu",     "B.Tech CSE (AI), Invertis Univ '28"),
    ("kv", "Award",   "Inverthon 2.0 Winner"),
    ("kv", "Loc",     "Shahjahanpur, Uttar Pradesh, India"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "ML / DS", "Scikit-learn, XGBoost, TFLite, Pandas"),
    ("kv", "Web",     "Flask, FastAPI, React, Vite"),
    ("kv", "Cloud",   "AWS Lambda · S3 · API Gateway"),
    ("kv", "Lang",    "Python · C · SQL · JavaScript"),
    ("kv", "DB",      "MySQL · SQLite · PostgreSQL"),
    ("gap",),
    ("sec", "Projects"),
    ("bul", "MedLife — Healthcare AI (7-lang symptom mapping)"),
    ("bul", "FasalAI — Crop Advisory System (SIH25010)"),
    ("bul", "Tata Motors Sales Intel (XGBoost R²=0.9953)"),
    ("bul", "IPL Playing XI Predictor (2008-2025 stats)"),
]
